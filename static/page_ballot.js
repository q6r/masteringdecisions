      ...
      for (var i = 0; i < alternative_names.length; i++) {
        ...
        if (alt_vote_style == "5") {
          for (var j = 0; j < criterion_names.length; j++) {
            page += "<td>" + "<div class=\"dropup\">" + "<button class=\"btn btn-default dropdown-toggle center\" type=\"button\" id=\"dropdownMenu" + i + j + "\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">" + "<div id=\"alt" + i + "crit" + j + "_color\" class=\"color_pick\"></div>" + "</button>" + "<ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu" + i + j + "\">" + "<li id=\"alt" + i + "crit" + j + "r\" class=\"vote-red\">Red</li>" + "<li id=\"alt" + i + "crit" + j + "r\" class=\"vote-orange\">Orange</li>" + "<li id=\"alt" + i + "crit" + j + "y\" class=\"vote-yellow\">Yellow</li>" + "<li id=\"alt" + i + "crit" + j + "y\" class=\"vote-greenyellow\">Green Yellow</li>" + "<li id=\"alt" + i + "crit" + j + "g\" class=\"vote-green\">Green</li>" + "</ul>" + "</div>" + "</td>";
          }
        } else { //3
          for (var j = 0; j < criterion_names.length; j++) {
            page += "<td>" + "<div class=\"dropup\">" + "<button class=\"btn btn-default dropdown-toggle center\" type=\"button\" id=\"dropdownMenu" + i + j + "\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">" + "<div id=\"alt" + i + "crit" + j + "_color\" class=\"color_pick\"></div>" + "</button>" + "<ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu" + i + j + "\">" + "<li id=\"alt" + i + "crit" + j + "r\" class=\"vote-red\">Red</li>" + "<li id=\"alt" + i + "crit" + j + "y\" class=\"vote-yellow\">Yellow</li>" + "<li id=\"alt" + i + "crit" + j + "g\" class=\"vote-green\">Green</li>" + "</ul>" + "</div>" + "</td>";
          }
        }
        page += "</tr>";
      }
